...
export class DepartmentService {
  ...
  async updateListSubject(departmentId: string, subjectId: any): Promise<DepartmentDocument> {
    ...
    const oldDepartment = await this.departmentModel.findById(dpmObjectId).exec();
